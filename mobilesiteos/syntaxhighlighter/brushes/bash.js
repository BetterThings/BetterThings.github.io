...
msos.provide("syntaxhighlighter.brushes.bash");
msos.require("msos.syntaxhighlighter");

syntaxhighlighter.brushes.bash.version = new msos.set_version(13, 6, 14);


syntaxhighlighter.brushes.bash.brush = function () {
