...
ng.bootstrap.ui.modal.version = new msos.set_version(14, 9, 28);


// Note: use msos.require("ng.bootstrap.ui"); before AngularJS "bootstrapping" for ui.bootstrap.transition
// Below is the standard plugin, except for templateUrl location
angular.module('ng.bootstrap.ui.modal', ['ng.bootstrap.ui.transition'])
