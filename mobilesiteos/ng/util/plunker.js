...
msos.provide("ng.util.plunker");

ng.util.plunker.version = new msos.set_version(14, 9, 22);


// Below is the standard plunker code, except plunker -> ng.util.plunker
angular.module('ng.util.plunker', [])
