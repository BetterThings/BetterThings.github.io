...
msos.provide("ng.resource.mongolab");

ng.resource.mongolab.version = new msos.set_version(14, 7, 31);


// Below is the standard mongolabResourceHttp code, except mongolabResourceHttp -> ng.resource.mongolab
angular.module('ng.resource.mongolab', []).factory('$mongolabResourceHttp', ['MONGOLAB_CONFIG', '$http', '$q', function (MONGOLAB_CONFIG, $http, $q) {
