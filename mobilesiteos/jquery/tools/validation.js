 ...
 */
msos.provide("jquery.tools.validation");

jquery.tools.validation.version = new msos.set_version(13, 6, 14);


// Below are the std. 'en' language validator rules, followed by the std. form validator script
(function ($) {
