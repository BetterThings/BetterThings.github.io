...
// Adapted for use thru MobileSiteOS.

// msos: start
msos.provide("jquery.tools.mousepress");

jquery.tools.mousepress.version = new msos.set_version(13, 6, 14);
// msos: end


// Below is std. jquery.tools module
...
(function($){
	...
	$.event.special.mousepress = {
		...
		handler: function(elem, e){
			return ($.event.dispatch || $.event.handle).call(elem, {type: 'mousepress', target: e.target, pageX: e.pageX, pageY: e.pageY});
		}
	};
