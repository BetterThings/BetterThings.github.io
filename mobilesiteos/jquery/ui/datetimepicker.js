...
// msos: start
msos.provide("jquery.ui.datetimepicker");
...
// Below is std. jquery-ui.js module except we delay code execution, (no '(function ($) { }(jQuery))' stuff)
jquery.ui.datetimepicker.start = function () {
	"use strict";
...
// Allow jquery.ui.datepicker to load, but run before the page's js file is run
msos.onload_func_start.push(jquery.ui.datetimepicker.start);