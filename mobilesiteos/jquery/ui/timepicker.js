...
// 'jquery-ui.js' includes ui core, widget, mouse, position, draggable already bundled.
...
// Below is std. module except: added notranslate to <table class="ui-timepicker notranslate">
(function ($) {
        ...
        _generateHTML: function (inst) {
            ...
            if (showHours) {
                ...
                html += '<td class="ui-timepicker-hours">' +
                        ...
                        hourLabel +
                        '</div>' +
                        '<table class="ui-timepicker notranslate">';
