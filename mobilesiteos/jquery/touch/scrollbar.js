 ...
 */
msos.provide("jquery.touch.scrollbar");
msos.require("jquery.tools.mousewheel");

jquery.touch.scrollbar.version = new msos.set_version(13, 6, 14);
...
((function ($) {
    ...
    $.fn.perfectScrollbar = function (suppliedSettings, option) {
        ...
        var $this = $(this).addClass('ps-container'),
            ...
            containerWidth, containerHeight, contentWidth, contentHeight, scrollbarXWidth, scrollbarXLeft, scrollbarXBottom = parseInt($scrollbarX.css('bottom'), 10),
            scrollbarYHeight, scrollbarYTop, scrollbarYRight = parseInt($scrollbarY.css('right'), 10);
