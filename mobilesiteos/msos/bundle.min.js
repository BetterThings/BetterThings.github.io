msos.console.info('msos/bundle.min -> start.');
msos.console.time('bundle');
...
msos.console.info('msos/bundle.min -> done!');
msos.console.timeEnd('bundle');